...
import { testXml } from '../components/XmlTest';
...
// https://www.npmjs.com/package/react-range-slider-input

// fix inconsistent scroll behavior in beats and blocks
// add font size in beats options
// fix beat generation when deleting all the input (fallback value)
          ...
          <div className="fieldset-container">
            <fieldset className="options-container">
              ...
              <div className="option-container">
                ...
                {/* <div className="option">
                  <label htmlFor="font-color">Base Color</label>
                  <input
                    type="color"
                    id="color"
                    name="font-color"
