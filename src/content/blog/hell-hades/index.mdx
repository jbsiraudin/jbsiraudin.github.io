...
<Admonition type="caution">**Wether you like roguelikes or not, you should play Hades.** And this article spoils a large part of its game systems, so I strongly advise you to play it first.</Admonition>
...
<Highlight bold size="24px" mt={20} mb={10}>
...
<Highlight bold size="21px" mt={20}>
...
<Admonition type="note">I find this calculus fun for hero-based arena games, like _League of Legends_ or _Rainbow Six Siege_. The roster of the characters is often huge, theoretically offering unique combinations each game.</Admonition>
...
<Highlight bold="bolder" size="21px" mt={20} color="crimson">
...
<Admonition type="note">It's very logical that the % of coverage increases across the biomes: Statistically, you'll see Tartarus way more than Elysium, so it makes sense that Tartarus is more diverse. Another reason would be on the production side: Hades was in early access and the later biomes came in title updates, when you don't necessarly have as much cooking time as for the first biomes.</Admonition>
