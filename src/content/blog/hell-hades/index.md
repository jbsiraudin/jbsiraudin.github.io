...
description: "Exploring combinatorics in Hades — and why quintillions of possible runs don't actually matter."
date: 2021-07-02
draft: false
...
import Arrangements from "@components/Combinatorics/Arrangements"
import HadesCarousel from "@components/Combinatorics/HadesCarousel"
...
<HadesCarousel client:load world="Tartarus" length={24} />
<p style={{ textAlign: "center", fontWeight: "bold", marginTop: 20, marginBottom: 10, fontSize: "24px" }}>
  11 rooms of Asphodel
</p>
<HadesCarousel client:load world="Asphodel" length={11} />
<p style={{ textAlign: "center", fontWeight: "bold", marginTop: 20, marginBottom: 10, fontSize: "24px" }}>
  13 rooms of Elysium
</p>
<HadesCarousel client:load world="Elysium" length={13} />
