...
<br/>
<Video client:load srcVideo="/img/illustrations/Dolly3.mp4" legend="Doug blesses us with debug display footage showing the dynamic control of FoV and follow distance." />
<br/>
...
<Image srcImage="https://compo.thasauce.net/files/materials/OHC726_OHC_726_2.gif" legend="Poltergeist (1982)" />
...
<Highlight size={12} align="left">All the Spider-Man additional gameplay of this article was extracted from <a href="https://youtu.be/eEPG4TMhwtk" target="_blank" rel="noopener noreferrer">this video</a>.</Highlight>
